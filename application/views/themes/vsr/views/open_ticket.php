<section id="main-content">
   <div class="container">
      <div class="row content">
         <div class="col-md-12">
            <h3 class="title text-none">Gửi yêu cầu hỗ trợ</h3>
         </div>
            ...
            <?php echo form_open_multipart('clients/open_ticket',array('id'=>'open-new-ticket-form')); ?>
               <div class="row">
                  ...
                  <div class="col-md-12 text-center mtop20">
                     <button type="submit" class="btn btn-info w-100" data-form="#open-new-ticket-form" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>">Gửi yêu cầu</button>
                  </div>
               </div>
            <?php echo form_close(); ?>
         </div>
