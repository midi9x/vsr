                        ...
                        <div class="col-md-12 data">
                            <form action="#" method="POST" action="">
                                ...
                                <div class="row mr-0">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" name="name" class="form-control" placeholder="Điện thoại" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" name="dia-chi" class="form-control" placeholder="Địa chỉ" required="">
                                    </div>
                                </div>
                                <div class="col-md-12 form-group">
                                    <textarea class="form-control" id="exampleTextarea" rows="8" placeholder="Lời nhắn" required=""></textarea>
                                </div>
