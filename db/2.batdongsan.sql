...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th7 01, 2018 lúc 05:23 PM
...
INSERT INTO `news` (`articleid`, `articlegroup`, `subject`, `description`, `slug`, `avatar`, `seo_title`, `seo_description`, `active`, `datecreated`, `article_order`) VALUES
(3, 4, 'test', '2', 'test', 'http://batdongsan.local/media/noimage-1.png', '1', '1', 1, '2018-06-30 10:20:32', 2);
...
INSERT INTO `newsgroups` (`groupid`, `name`, `group_slug`, `description`, `active`, `group_order`) VALUES
(4, '234', '234', '234', 1, 2),
(5, '323', '323', '23', 1, 3),
(6, 'ew', 'ew', 'ew', 0, 30),
(7, '2', '2-4', '2', 1, 5),
...
(1, 'Đất nền phú quốc', 'http://batdongsan.local/media/noimage-1.png', '<div style=\"text-align: center;\"><a href=\"http://batdongsan.local/\">OK ngon</a></div>\r\n<div><img src=\"http://batdongsan.local/media/noimage.png\" width=\"525\" height=\"421\" alt=\"\" style=\"display: block; margin-left: auto; margin-right: auto;\" /></div>', 1, 1, 1, 1, 0, '', '', '', '', 'dat-nen-phu-quoc', '1', '1', '2018-06-24 12:10:07', 1, 1, 3);
...
--
-- Đang đổ dữ liệu cho bảng `property_contacts`
--

INSERT INTO `property_contacts` (`contact_id`, `property_id`, `contact_name`, `contact_phone`, `contact_email`, `contact_address`, `contact_message`, `contact_status`) VALUES
(1, 1, 'xx2', 'xx', 'xx', 'xx', 'xx', 2),
(2, 1, 'xx', 'xx', 'xx', 'xx', 'xx', 2);
...
(48, 7, 'http://batdongsan.local/media/noimage.png'),
(49, 7, 'http://batdongsan.local/media/noimage.png');
...
(1, 'midi9x@gmail.com', 'Dinh', 'Nguyen', NULL, NULL, NULL, NULL, '$2a$08$zsOz5XDjRWXIVKLVBtYlyOmTDvhj3ZYvsCO.OISMImrBAqoSokc8e', '2018-06-15 17:02:05', NULL, '127.0.0.1', '2018-07-01 13:46:58', '2018-07-01 13:49:07', NULL, NULL, NULL, 1, NULL, 1, NULL, NULL, NULL, 0, '0.00', 0, NULL, NULL, NULL);
