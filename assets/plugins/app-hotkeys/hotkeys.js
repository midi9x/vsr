(function($) {
    ...
    var special = {
        ...
        'f12': 123,
        '?': 191, // Question mark
        'minus': app_user_browser == 'opera' ? [109, 45] : app_user_browser == 'mozilla' ? 109 : [189, 109],
        'plus': app_user_browser == 'opera' ? [61, 43] : app_user_browser == 'mozilla' ? [61, 107] : [187, 107]
    };
    ...
    $.Shortcuts.start = function(list) {
        ...
        $(document).on((app_user_browser == 'opera' ? 'keypress' : 'keydown') + '.shortcuts', function(e) {
