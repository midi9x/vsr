                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="edit_characteristic(this,<?php echo $characteristic['characteristic_id']; ?>); return false" data-name="<?php echo $characteristic['characteristic_name']; ?>" data-description="<?php echo clear_textarea_breaks($characteristic['characteristic_description']); ?>" data-order="<?php echo $characteristic['characteristic_order']; ?>" data-active="<?php echo $characteristic['characteristic_active']; ?>" data-slug="<?php echo $characteristic['characteristic_slug']; ?>" data-seo-title="<?php echo $characteristic['characteristic_seo_title']; ?>" data-seo-description="<?php echo $characteristic['characteristic_seo_description']; ?>" class="btn btn-default btn-icon"><i class="fa fa-pencil-square-o"></i></a>
                                        <?php } ?>
