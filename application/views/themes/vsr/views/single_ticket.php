                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="ticket-status-inline">
                                                    <span class="label pull-right bold" style="padding: 0 5px;background:<?php echo $ticket->statuscolor; ?>">
                                                        <?php echo ticket_status_translate($ticket->ticketstatusid); ?>
                                                        <?php if(get_option('allow_customer_to_change_ticket_status') == 1){ ?>
                                                            <i class="fa fa-pencil-square-o pointer toggle-change-ticket-status"></i>
                                                        </span>
                                                    <?php } ?>
                                                </div>
                                                <?php if(get_option('allow_customer_to_change_ticket_status') == 1){ ?>
