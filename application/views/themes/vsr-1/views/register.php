<section class="headings">
    <div class="text-heading text-center">
        <div class="container">
            <h1>Đăng ký</h1>
            <h2><a href="<?=site_url()?>">Trang chủ </a> &nbsp;/&nbsp; Đăng ký</h2>
        </div>
    </div>
</section>
<div class="py-4" id="register">
        ...
        <div class="panel-body">
           ...
           <?php } ?>
            <div class="col-md-12 text-center">
                <div class="form-group">
                    <button type="submit" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>" class="btn btn-primary"><?php echo _l('clients_register_string'); ?></button>
                </div>
            </div>
       </div>
   </div>
