            ...
            <div class="col-md-9" id="primary">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h3 class="title text-none"><?php echo _l('clients_profile_heading'); ?></h3>
                        <div class="panel_s">
                            <div class="panel-body">
                                ...
                                <?php if($contact->is_primary == 1){ ?>
                                    <div class="col-md-12 text-right mtop20">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-info w-100"><?php echo _l('clients_edit_profile_update_btn'); ?></button>
                                        </div>
                                    </div>
                                <?php } ?>
                            </div>
