...
<div class="table-responsive s_table">
 <table class="table credite-note-items-table items table-main-credit-note-edit no-mtop">
  <thead>
   <tr>
    <th></th>
    <th width="20%" align="left"><i class="fa fa-exclamation-circle" aria-hidden="true" data-toggle="tooltip" data-title="<?php echo _l('item_description_new_lines_notice'); ?>"></i> <?php echo _l('credit_note_table_item_heading'); ?></th>
    <th width="25%" align="left"><?php echo _l('credit_note_table_item_description'); ?></th>
    <?php
  ...
  <th width="15%" align="right"><?php echo _l('credit_note_table_rate_heading'); ?></th>
  <th width="20%" align="right"><?php echo _l('credit_note_table_tax_heading'); ?></th>
  <th width="10%" align="right"><?php echo _l('credit_note_table_amount_heading'); ?></th>
    ...
    <td>
     ...
     <div class="col-md-5">
      <div class="input-group" id="discount-total">
       ...
       <input type="number" value="<?php echo (isset($credit_note) ? $credit_note->discount_percent : 0); ?>" class="form-control pull-left input-discount-percent<?php if(isset($credit_note) && !is_sale_discount($credit_note,'percent') && is_sale_discount_applied($credit_note)){echo ' hide';} ?>" min="0" max="100" name="discount_percent">
       ...
       <div class="input-group-addon">
        ...
        <ul class="dropdown-menu" id="discount-total-type-dropdown" aria-labelledby="dropdown_menu_tax_total_type">
          <li>
            <a href="#" class="discount-total-type discount-type-percent<?php if(!isset($credit_note) || (isset($credit_note) && is_sale_discount($credit_note,'percent')) || (isset($credit_note) && !is_sale_discount_applied($credit_note))){echo ' selected';} ?>">%</a>
          </li>
          <li>
            <a href="#" class="discount-total-type discount-type-fixed<?php if(isset($credit_note) && is_sale_discount($credit_note,'fixed')){echo ' selected';} ?>">
