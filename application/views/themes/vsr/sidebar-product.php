<div class="col-md-3 pl-md-0 news-sidebar" id="secondary">
	...
	<h3 class="title text-none mt-3">Sản phẩm hot</h3>
	<div class="section-content">
		<div class="section">
			<?php
				$properties = get_product_hot();
						...
						<div class="col-md-8 pl-md-0">
							...
							<p class="info">
								<span class="float-left">
									...
									<a class="category-name" href="<?php echo site_url('/') . PRODUCT_SLUG?>?location=<?=$property['property_location_id']?>" title="<?php echo $property['location_name']?>">
