<section id="main-content">
	<div class="container">
		<div class="row content">
			<div class="col-md-12">
				<h3 class="title float-left text-none">Sản phẩm</h3>
				<a class="d-block d-md-inline ml-md-5 clear-sm-about" href="<?php echo site_url('/') . PRODUCT_SLUG ?>?location=1">Phú Quốc</a>
				<a class="d-block d-md-inline ml-md-5 clear-sm-about" href="<?php echo site_url('/') . PRODUCT_SLUG ?>?location=2">Vân Đồn</a>
				<a class="d-block d-md-inline ml-md-5 clear-sm-about" href="<?php echo site_url('/') . PRODUCT_SLUG ?>?location=3">Bắc Vân Phong</a>
			</div>
									...
									<?php foreach ($properties as $key => $property): ?>
										<div class="row mt-3">
											<div class="col-md-4 pr-md-0">
												<a href="<?php echo site_url('/') . PRODUCT_SLUG . $property['property_slug']?>" title="<?php echo $property['property_name']?>">
											...
											<div class="col-md-8">
												...
												<p class="info">
													<span class="float-left">
														...
														<a href="<?php echo site_url('/') . PRODUCT_SLUG?>?location=<?=$property['property_location_id']?>&town=<?=$property['property_town_id']?>" title="<?php echo $property['town_name'] . ', ' . $property['location_name']?>">
												...
												<div class="row align-items-top">
													...
													<div class="col-md-4 info-bds align-middle mb-3 text-right">
														<?php if (isset($property['property_price']) && $property['property_price'] != ''): ?>
															<div class="price"><?php echo number_format($property['property_price']) ?>đ</div>
														<?php endif; ?>
														...
														<?php if (isset($property['property_quyhoach']) && $property['property_quyhoach'] != ''): ?>
															<div class="quyhoach">Quy hoạch: <?php echo $property['property_quyhoach'] ?></div>
														<?php endif; ?>
													</div>
												</div>
											</div>
