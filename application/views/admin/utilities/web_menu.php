  ...
  <div class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="panel_s">
          ...
          <?php
          $menu_active = get_option('web_menu_active');
          $menu_active = json_decode($menu_active);
          $menu_inactive = get_option('web_menu_inactive');
          ...
          <div class="row">
            <div class="col-md-6 border-right">
              ...
              <div class="dd active">
                ...
                if(count($menu_active->web_menu_active) == 0){ ?>
                <li class="dd-item dd3-empty"></li>
                <?php }
                foreach($menu_active->web_menu_active as $item){
                  ?>
                  ...
                  <div class="menu-options main-item-options" style="display:none;" data-menu-options="<?php echo $item->id; ?>">
                   ...
                   <div class="input-group mbot15">
                    ...
                    ?>
                    <input type="text" value="<?php echo $url; ?>" class="form-control main-item-url" name="url-menu-item-<?php echo $item->id; ?>">
                  ...
                  <label class="control-label" style="display: none"><?php echo _l('utilities_menu_icon'); ?></label>
                ...
                <li class="dd-item dd3-item sub-items" data-id="<?php echo $submenu->id; ?>" data-permission="<?php echo $submenu->permission; ?>">
                 ...
                 <div class="menu-options sub-item-options" style="display:none;" data-menu-options="<?php echo $submenu->id; ?>">
                   ...
                   <div class="input-group">
                    ...
                    ?>
                    <input type="text" value="<?php echo $url; ?>" class="form-control sub-item-url" name="url-menu-item-<?php echo $submenu->id; ?>">
                    <span class="input-group-addon"><i class="fa fa-question" data-toggle="tooltip" data-placement="left" data-title="<?php echo _l('utilities_menu_url_help',admin_url()); ?>"></i></span>
                  </div>
                  <label class="control-label" style="display: none"><?php echo _l('utilities_menu_icon'); ?></label>
                  <div class="input-group" style="display: none;">
   ...
   <div class="col-md-6">
     ...
     <div class="dd inactive">
      ...
      $i = 1;
      echo '<ol class="dd-list">'; ?>
      <?php if(count($menu_inactive->web_menu_inactive) == 0){ ?>
      <li class="dd-item dd3-empty"></li>
      <?php } ?>
      <?php
      foreach($menu_inactive->web_menu_inactive as $item){
        ?>
        <li class="dd-item dd3-item main" data-id="<?php echo $item->id; ?>" data-permission="<?php echo $item->permission; ?>">
         <div class="dd-handle dd3-handle"></div>
         <div class="dd3-content"><?php echo _l($item->name); ?>
...
<script>
  ...
  function save_menu() {
    ...
    var web_menu_active = $('.dd.active').nestable('serialize');
    /* Inactive */
    ...
    var web_menu_inactive = $('.dd.inactive').nestable('serialize');
    var data = {};
    data.active = web_menu_active;
    data.inactive = web_menu_inactive;
    $.post(admin_url + 'utilities/update_web_menu', data).done(function() {
