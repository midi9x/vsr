						...
						<div class="row">
							<div class="col-md-12">
								<?php if($contact->profile_image == NULL){ ?>
									<div class="form-group">
										...
										<input type="file" name="profile_image" class="form-control" id="profile_image" style="margin-bottom: 0;width: 100%;">
									</div>
									<?php } ?>
									<?php if($contact->profile_image != NULL){ ?>
									<div class="form-group">
							...
							<div class="row p15">
								<div class="col-md-12 text-right mtop20">
									<div class="form-group">
										<button type="submit" class="btn btn-info pointer"><?php echo _l('clients_edit_profile_update_btn'); ?></button>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="col-md-4">
				...
				<div class="panel_s">
					<div class="panel-body">
						...
						<div class="form-group">
							<button type="submit" class="btn btn-info pointer btn-block"><?php echo _l('clients_edit_profile_change_password_btn'); ?></button>
						</div>
						<?php echo form_close(); ?>
					</div>
