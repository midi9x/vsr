				...
				<div class="section-content">
					<?php if (count($advices) > 0): ?>
						<div class="section">
							...
							<span class="float-right my-2"><a class="read-more" href="<?php echo site_url('/') . ADVICES_LOCATION_SLUG?>phu-quoc" title="Xem tiếp">Xem tiếp ...</a></span>
						</div>
					<?php endif;?>
					...
					<?php if (count($mreports) > 0): ?>
						<div class="section">
							...
							<span class="float-right my-2"><a class="read-more" href="<?php echo site_url('/') . MREPORTS_LOCATION_SLUG?>phu-quoc" title="Xem tiếp">Xem tiếp ...</a></span>
						</div>
					<?php endif;?>
					...
					<?php if (count($products) > 0): ?>
						<div class="section bdstt">
							...
							<span class="float-right my-2"><a class="read-more" href="<?php echo site_url('/') . PRODUCT_SLUG?>?location=1">Xem tiếp ...</a></span>
						</div>
					<?php endif;?>
					...
					<?php if (count($projects) > 0): ?>
						<div class="section bdstt">
							...
							<span class="float-right my-2"><a class="read-more" href="<?php echo site_url('/') . PROJECT_SLUG?>?location=1">Xem tiếp ...</a></span>
						</div>
					<?php endif;?>
				</div>
			</div>
