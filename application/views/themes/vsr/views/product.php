<section id="main-content">
    <div class="container">
        <div class="row content">
                ...
                <div class="section-content">
                    <div class="section">
                        ...
                        <div class="post-info mt-3 mb-3">
                            ...
                            <div class="fb-like" data-href="<?php echo site_url('/') . PRODUCT_SLUG . $property->property_slug?>" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
                            <div class="zalo-share-button" data-href="<?php echo site_url('/') . PRODUCT_SLUG . $property->property_slug?>" data-oaid="3622065111560619881" data-layout="1" data-color="blue" data-customize=false></div>
                        ...
                        <h3 class="title text-none mt-3 clear-sm-about">Sản phẩm tương tự</h3>
                        <div class="section-content">
                            <div class="section bdstt">
                                <?php foreach ($relateds as $key => $related):?>
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        <a href="<?php echo site_url('/') . PRODUCT_SLUG . $related['property_slug']?>" title="<?php echo $related['property_name']?>">
                                    ...
                                    <div class="col-md-8">
                                        <h4>
                                            <a href="<?php echo site_url('/') . PRODUCT_SLUG . $related['property_slug']?>" title="<?php echo $related['property_name']?>"><?php echo $related['property_name']?></a>
                                        </h4>
                                        <p class="info">
                                            <span class="float-left">
                                                ...
                                                <a href="<?php echo site_url('/') . PRODUCT_SLUG?>?location=<?=$related['property_location_id']?>&town=<?=$related['property_town_id']?>" title="<?php echo $related['town_name'] . ', ' . $related['location_name']?>">
                                        ...
                                        <div class="row text-center mx-0">
                                            ...
                                            <?php if ($related['property_quyhoach'] != ''): ?>
                                                <div class="col-md-4 info-item mb-1 bl">
                                                    Quy hoạch: <?php echo $related['property_quyhoach']?>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
            ...
            <?php $this->view('themes/' . active_clients_theme() . '/sidebar-product');?>
        </div>
    </div>
</section>